...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (document.querySelector('#checkout-form')) { displayCheckoutSummary(); }
...
function displayCheckoutSummary() {
    ...
    /* 2a. DOM Manipulation to set the amount field to the calculated total */
    if (amountInput) {
